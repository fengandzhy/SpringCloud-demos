...
import org.frank.spring.cloud.order.client.ProductClient;
...
import org.frank.spring.cloud.order.utils.JsonUtils;
...
//        Map<String,Object> productMap = restTemplate.getForObject(url, Map.class);
        ...
        String response = client.findProdById(productId);
        Product product = JsonUtils.parseObject(response,Product.class);        
